...
export class CreateDatabase1555238394699 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "rating" ("id" varchar PRIMARY KEY NOT NULL, "userId" varchar NOT NULL, "questionId" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_rating" ("id" varchar PRIMARY KEY NOT NULL, "userId" varchar NOT NULL, "questionId" varchar, CONSTRAINT "FK_7c5e12c1f0bd305ae633f64fc56" FOREIGN KEY ("questionId") REFERENCES "question" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_rating"("id", "userId", "questionId") SELECT "id", "userId", "questionId" FROM "rating"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "rating" ("id" varchar PRIMARY KEY NOT NULL, "userId" varchar NOT NULL, "questionId" varchar)`);
        await queryRunner.query(`INSERT INTO "rating"("id", "userId", "questionId") SELECT "id", "userId", "questionId" FROM "temporary_rating"`);
